...
def trigrams():
	...
	for x in range(3):
		num = change(last)
		last = last - num
		counter = counter + changes[num]
	return QuadroSymbol[(ALL-counter)/4]

def fortune_telling():
	""" Launch fortune-telling """
	originResult = [0, 0, 0, 0, 0, 0]
	changedResult = [0, 0, 0, 0, 0, 0]
	changeCounter = 0
	changedYao = [0, 0, 0, 0, 0, 0]

	for x in range(6):
		originResult[x] = trigrams()
		if originResult[x] == 2 or originResult[x] == 3:
			changedResult[x] = originResult[x]
		elif originResult[x] == 1:
			changeCounter = changeCounter + 1
			changedResult[x] = 2
			changedYao[x] = 1 
		elif originResult[x] == 4:
			changeCounter = changeCounter + 1
			changedResult[x] = 3
			changedYao[x] = 1
	...
	for x in originResult:
		origin = origin + str(YinYang[x])

	for x in changedResult:
		changed = changed + str(YinYang[x])

	print "本卦: %s" % Gua64[origin]

	if changeCounter != 0:
		print "变卦: %s" % Gua64[changed]
	...
	if changeCounter == 0:
		...
		print "一爻变，以本卦变爻辞占"
	elif changeCounter == 2:
		print "二爻变，以本卦二变爻辞占"
	elif changeCounter == 3:
		print "三爻变，以本卦卦辞及变卦卦辞占"
	elif changeCounter == 4:
		print "四爻变，以变卦二不变爻辞占"
	elif changeCounter == 5:
		print "五爻变，以变卦不变爻辞占"
	elif changeCounter == 6:
		print "六爻变，乾坤二用，余卦用变卦卦辞占"
